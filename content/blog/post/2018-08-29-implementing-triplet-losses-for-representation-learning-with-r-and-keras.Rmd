...
All the R code for this post is available on GitHub: [road2stat/deep-learning-recipes](https://github.com/road2stat/deep-learning-recipes).

![[Three Palms](https://unsplash.com/photos/eZt5mvF7RcU) by Jamie Davies.](/image/three-palms-jamie-davies.jpg)
...
![A barebone matrix factorization model with a triplet loss for recommender systems with implicit feedback data.](/image/triplet-loss-model-keras.png)
...
![The first 20 epochs: loss and user-averaged AUC for the margin-based triplet loss model.](/image/triplet-loss-margin-movielens.png)
...
![The first 20 epochs: loss and user-averaged AUC for the BPR triplet loss model.](/image/triplet-loss-bpr-movielens.png)
