...
> TL;DR: here is a curated list of R packages that offer extended UI or server components for Shiny: [road2stat/awesome-shiny-extensions](https://github.com/road2stat/awesome-shiny-extensions). Pull requests welcomed!
...
Of course, the Shiny ecosystem evolved a lot (for the better) these years, and there is so many stuff I don't even know exist or possible before. Therefore, I decided to start a repo on GitHub to collect and organize the awesome R packages that offer reusable, extended UI or server components for Shiny: [road2stat/awesome-shiny-extensions](https://github.com/road2stat/awesome-shiny-extensions). In case it helps someone save time to find something or gain knowledge about what's out there, that would be all I wished for.
