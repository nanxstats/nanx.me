...
&middot; <a href="#sbpack-r">sbpack-r</a>
...
&middot; <a href="#cwl-exploder">cwl-exploder</a>
...
&middot; <a href="#nanx-app">nanx.app</a>
</p>
...
<div class="col-md-9">
<h3>sbpack-r: Pack and Upload CWL Apps to Seven Bridges Powered Platforms</h3>
<p>
...
<p>
<a href="https://nanx.me/sbpack-r/" class="btn btn-outline-primary">Docs</a>
<a href="https://github.com/nanxstats/sbpack-r" class="btn btn-outline-primary">GitHub</a>
</p>
</div>
</div>
</div>
...
<a class="anchor" id="cwl-exploder"></a>
...
<div class="col-md-9">
<h3>cwl-exploder: unpack monolithic CWL workflows</h3>
<p>
A shiny app to unpack monolithic CWL workflows and split them into smaller components.
</p>
<p>
<a href="https://nanx.app/cwl-exploder/" class="btn btn-outline-primary">Mirror 1</a>
<a href="https://github.com/nanxstats/cwl-exploder" class="btn btn-outline-primary">GitHub</a>
</p>
</div>
</div>
</div>
...
<a class="anchor" id="cwl-upgrader"></a>
...
<div class="col-md-9">
<h3>cwl-upgrader: upgrade CWL apps</h3>
<p>
A shiny app to upgrade Common Workflow Language (CWL) apps from sbg:draft2 to v1.0.
</p>
<p>
...
<div class="col-md-9">
<h3>ProtrWeb: Shiny app for computing protein sequence-derived descriptors</h3>
<p>
...
<div class="col-md-9">
<h3>TargetNet: Shiny app for drug target identification with large-scale public binding affinities data</h3>
<p>
...
<div class="col-md-9">
<h3>ImgSVD: Shiny app for image compression via singular value decomposition</h3>
<p>
Shiny app for image compression via singular value decomposition (SVD).
...
<div class="col-md-9">
<h3>hdnom-app: interactive benchmarking and visualization of penalized Cox models</h3>
<p>
A shiny app built on the hdnom package.
Streamlines nomogram building, model validation,
...
<div class="col-md-9">
<h3>Signify: Make your <em>p</em>-value "sound significant"</h3>
<p>
A shiny app for making your (>0.05) <em>p</em>-values "sound significant".
Powered by the data from
...
<p>
<a href="https://nanx.app" class="btn btn-outline-primary">nanx.app</a>
<a href="https://github.com/nanxstats/nanx.app" class="btn btn-outline-primary">GitHub</a>
</p>
</div>
</div>
</div>
